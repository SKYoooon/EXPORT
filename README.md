***
# **About**
FastCampus ByteDegree EXPORT 과정은 현업에서 자주 사용되는 SQL, Python, Excel, Tableau을 사용하여 개인 프로젝트를 진행했습니다.<br/>
인사, 제조, 이커머스 분야의 데이터를 분석하고 인사이트를 도출하였습니다.<br/>
현직자분들의 피드백을 통해, 데이터 분석 역량을 키웠으며 **최우수 5인**으로 선정되었습니다.   <br/>
